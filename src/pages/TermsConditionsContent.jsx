// src/pages/TermsConditionsContent.jsx
import React from "react";

export default function TermsConditionsContent() {
  return (
    <main className="flex-grow pt-8 px-4 sm:px-6 lg:px-8 bg-white">
      ...
      <div className="space-y-10 w-full">
        ...
        <section className="px-4 lg:px-16">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            information. You are responsible for safeguarding the password that you use to
        ...
        <section className="px-4 lg:px-16">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            remain the exclusive property of Cloudnest and its licensors.
          </p>
        </section>
